...
AS
    ...
    A.DATE_KEY
		...
		,WFYP = 
		CASE 
			WHEN P.PLAN_ID = 'KBE003' AND ((P.POL_BILL_TYP_CD = 'P' AND A.POL_PREM_PAY_DUR in (15,12,9,6)) or A.POL_PREM_PAY_DUR = 6)
         		THEN A.AFYP/2
			WHEN P.PLAN_ID IN ('BCLS01', 'BCLP01') AND P.POL_BILL_TYP_CD = 'P' 
				THEN A.AFYP/2
			WHEN P.PLAN_ID = 'CBS001' AND P.POL_BILL_TYP_CD = 'P' THEN ROUND(A.AFYP * 0.10,2)
